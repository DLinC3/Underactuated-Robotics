...
function [J,PI] = brick_vi_mintime
global dt;
...
subplot(1,2,1);imagesc(q_bins,qdot_bins,reshape(PI,n1,n2)'); xlabel('q'); ylabel('q_{dot}'); title('u'); axis xy; axis equal;
subplot(1,2,2);imagesc(q_bins,qdot_bins,reshape(J,n1,n2)'); xlabel('q'); ylabel('q_{dot}'); title('Value function'); axis xy; axis equal;
