...
figure(10); n1 = length(q_bins); n2 = length(qdot_bins);
subplot(1,2,1);imagesc(q_bins,qdot_bins,reshape(PI,n1,n2)');xlabel('\theta'); ylabel('\omega'); title('u (Torque)'); axis xy; axis equal;
subplot(1,2,2);imagesc(q_bins,qdot_bins,reshape(J,n1,n2)');xlabel('\theta'); ylabel('\omega'); title('Value Function'); axis xy; axis equal;
